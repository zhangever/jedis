...
//    clusterHostAndPortList.add(new HostAndPort("localhost", 7379));
    clusterHostAndPortList.add(new HostAndPort("localhost", 6380));
    clusterHostAndPortList.add(new HostAndPort("localhost", 6381));
    clusterHostAndPortList.add(new HostAndPort("localhost", 6382));
