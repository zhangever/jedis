...
public class JedisPoolTest extends Assert {
    ...
    public void setUp() throws InterruptedException {
        Set<HostAndPort> hostAndPorts = new HashSet<HostAndPort>(4);
        hostAndPorts.add(new HostAndPort("localhost", 6380));
        hostAndPorts.add(new HostAndPort("localhost", 6381));
        hostAndPorts.add(new HostAndPort("localhost", 6382));
        cluster = new JedisCluster(hostAndPorts, 2000,
                3, new JedisPoolConfig());
    }

    public void setUpBroken() throws InterruptedException {
        Set<HostAndPort> hostAndPorts = new HashSet<HostAndPort>(4);
        hostAndPorts.add(new HostAndPort("localhost", 6380));
        hostAndPorts.add(new HostAndPort("localhost", 8899));
        hostAndPorts.add(new HostAndPort("localhost", 6382));
        cluster = new JedisCluster(hostAndPorts, 2000,
                3, new JedisPoolConfig());
    }
    ...
    @Test
    public void testPoolLeakDetect() throws InterruptedException {
        setUp();
    ...
    @Test
    public void testBrokenPoolLeakDetect() throws InterruptedException {
        setUpBroken();
        System.out.println(cluster.get("abc"));
        Thread.sleep(10000);
    }
    ...
    @Test
    public void testAsyncPoolLeakDetect() throws InterruptedException {
        setUp();
